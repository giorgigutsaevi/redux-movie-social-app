...
export const CREATE_REQUEST = '@@user/CREATE_REQUEST' // CREATING REQUEST
export const CREATE_SUCCESS = '@@user/CREATE_SUCCESS' // CREATING with success
export const CREATE_ERROR = '@@user/CREATE_ERROR' // CREATING with error

export const LOGIN_REQUEST = '@@user/LOGIN_REQUEST' // CREATING REQUEST
